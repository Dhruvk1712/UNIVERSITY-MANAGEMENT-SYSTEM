...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            if (Integer.parseInt(tfmarks5.getText()) <= 100 && Integer.parseInt(tfmarks1.getText()) <= 100 && Integer.parseInt(tfmarks2.getText()) <= 100 && Integer.parseInt(tfmarks3.getText()) <= 100 && Integer.parseInt(tfmarks4.getText()) <= 100) {
                try {
               ...
               JOptionPane.showMessageDialog(null,"Please enter marks less than 100");
            }
